...
uint8_t GameInteractor::State::GKShardGiven = 0;
...
// MARK: - GameInteractor::State::GKShardGiven
void GameInteractor_SetGKShardGiven(uint8_t state) {
    GameInteractor::State::GKShardGiven = state;
}
